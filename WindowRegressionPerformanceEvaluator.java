...
public class WindowRegressionPerformanceEvaluator extends AbstractOptionHandler
    ...
    protected Estimator averageErrorLogScale; // <---le08/02/18
    ...
    public void reset(int numClasses) {
        ...
        this.averageErrorLogScale = new Estimator(this.widthOption.getValue()); // <---le08/02/18
    ...
    public void addResult(Example<Instance> example, double[] prediction) {
        ...
        if (weight > 0.0) {
            ...
            if (prediction.length > 0) {
                ...
                this.averageErrorLogScale.add(Math.abs(tmpLogClassValue - tmpLogPrediction)); // <---le08/02/18
            }
 ...
 // <---le08/02/18
    public double getMeanErrorLogScale() {
        return this.weightObserved.total() > 0.0 ? this.averageErrorLogScale.total()
                / this.weightObserved.total() : 0.0;
    }
